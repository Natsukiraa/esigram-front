...
class CompleteOnboarding(private val userRepository: UserRepository) {
    suspend operator fun invoke(): Response<OnboardingStatus> = userRepository.completeOnboarding()
}